...
test("every exported protected server action awaits owner authorization first", () => {
  ...
  assert.equal(checked, 75); // 56 + Fase E: 5 + Fase I.1: 5 + Fase I.2 fixture: 3 + theme-ZIP-download: 1 + C3b content-plans: 3 + 0028 settings: 1 + Gmail send-as hercontrole: 1
});
