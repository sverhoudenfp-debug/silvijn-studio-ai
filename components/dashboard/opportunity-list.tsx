...
/** Fase 12 §P — top opportunities uit de echte lead-repository. */

export function OpportunityList({ leads }: { leads: Lead[] }) {
            ...
            <tbody>
              {top.map((lead) => (
                <tr key={lead.id} className="border-b border-zinc-800/50 last:border-0 hover:bg-zinc-800/30">
                  ...
                  <td className="py-2.5 pr-4 text-zinc-500">{websiteStatusMeta[lead.websiteStatus].label}</td>
                  <td className="py-2.5">
